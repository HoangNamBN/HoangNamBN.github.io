...
BinarySearchTree.prototype.findNode = function (value) 
{
  ...
  while (currentRoot) 
  {
    ...
    else 
    {
      ...
      document.getElementById("resultSearchGia").innerHTML ="Giá Bán :"+ " " +   currentRoot.value.gia;
      document.getElementById("resultSearchGn").innerHTML ="Giá Nhập :"+  " " +  currentRoot.value.giaNhap;
